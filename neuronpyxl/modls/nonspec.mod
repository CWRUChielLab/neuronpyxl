...
NEURON {
    SUFFIX nonspec
    RANGE numbtaus, numataus, A, B, Ainfonly, Binfonly, tmxAonly, tmxBonly, i, g, e, p, region, opt1, opt2, b, p1, p2, AnA, hA, sA, pA, tmxA, tminA, th1A, ts1A, tp1A, th2A, ts2A, tp2A, BnB, hB, sB, pB, tmxB, tminB, th1B, ts1B, tp1B, th2B, ts2B, tp2B
...
ASSIGNED {
    C (mM) i (mA/cm2) v (mV) area (um2) cai (mM) nai (mM) ki (mM) cli (mM) dreg(/ms) A () B ()
}
